...
(function () {
    ...
    openerp.website.RTE = openerp.website.RTE.extend({
        _config: function () {
            ...
            config.colorButton_colors = 'ffffff,383838,eeeeee,f49800,555555,d23da2,bd2830';
            ...
            config.stylesSet = [
                ...
                {name: 'p Klein', element: 'p', attributes: { 'class': 'dadi_small' } },
                {name: 'p Winzig', element: 'p', attributes: { 'class': 'dadi_tiny' } },
                {name: 'H1', element: 'h1'},
                {name: 'H2', element: 'h2'},
                {name: 'H3', element: 'h3'},
                {name: 'H4', element: 'h4'},
